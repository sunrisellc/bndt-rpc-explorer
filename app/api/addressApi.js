...
var banditoAddressApi = require("./banditoAddressApi.js");

function getSupportedAddressApis() {
	return ["blockchain.com", "blockchair.com", "blockcypher.com", "electrumx", "bandito"];
}
...
function getCurrentAddressApiFeatureSupport() {
	if (config.addressApi == "blockchain.com") {
        ...
        } else if (config.addressApi == "bandito") {
                return {
                        pageNumbers: false,
                        sortDesc: false,
                        sortAsc: false
	...
	return new Promise(function(resolve, reject) {
		...
		if (config.addressApi == "blockchain.com") {
			promises.push(blockchainAddressApi.getAddressDetails(address, scriptPubkey, sort, limit, offset));
                        ...
                        promises.push(banditoAddressApi.getAddressDetails(address));
